  ...
  return (
    <div className="flex justify-center items-center flex-col gap-2 w-full h-screen ">
      <div className="flex justify-center items-center flex-col gap-5 ">
        ...
        <div>
          <Link to={"/"} className="smx:w-44 text-sm bg-black p-3 w-48 text-white  tracking-widest">
            GO TO HOMEPAGE
          </Link>
        </div>
      </div>
      <div className="max-w-[15rem] max-h-[15rem] ">
        <img src={errorImg} alt="logo" className="h-w-auto" />
      </div>
    </div>
  );
};
