...
const Connect = () => {
  return (
    <div className="bg-slate-100 p-8 lg:flex-col smx:p-0">
      <h1 className="text-center font-bold text-2xl">LET'S CONNECT</h1>
      <div className="flex justify-center items-center p-5 smx:flex-col smx:p-0">
        <div className="flex flex-col w-1/2 mb-2">
          ...
          <input
            className="m-2 border-solid border-2 w-10/12 smx:w-44"
            type="text"
          ...
          />
          <textarea
            className="m-2 w-10/12 h-[9.5rem] border-solid border-2 smx:w-44"
            placeholder="Enter your message"
          ></textarea>
          <button className="p-1 w-1/4 m-2 smx:w-44 border-black border-solid border-2 star">
            Submit
          </button>
        </div>
